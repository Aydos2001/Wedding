        ...
        <>
            <Dialog open={open} handler={handleOpen} size="lg" className="rounded-[5px]">
                <DialogHeader className="pt-[15px] justify-center flex-col">
                    <p className="text-[16px] md:text-[15px] lg:text-[20px] font-spectral font-bold text-[#878910]">Ma'ka'n jayimiz</p>
                </DialogHeader>
                ...
                <DialogFooter>
                    <Button variant="filled" className="border-none outline-none rounded-sm text-[15px] px-[20px] bg-[#878910]" size="sm" onClick={handleOpen}>
                        <span>OK</span>
                    </Button>
                </DialogFooter>
            </Dialog>
